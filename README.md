# ⚡ LeetSync — LeetCode Auto-Commit + Productivity Suite
...
│   │       ├── leetsync-api.ts    # LeetSync backend API calls
...
- **Admin-only** add / edit / delete (email: `admin@leetsync.com`)
...
| Auth | JWT — dual backend (LeetSync + Clario/Productivity) |
| AI | Groq API (llama-3) |
...
3. Click the ⚡ LeetSync icon → **Settings** → paste your GitHub Personal Access Token (scope: `repo`)
