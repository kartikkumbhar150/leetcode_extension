// api/lib/db.ts
// Neon serverless PostgreSQL client + schema initialization
...
// Create the SQL tagged-template client (connection pooled via Neon)
export const sql = neon(DATABASE_URL);

// ─── Schema ───────────────────────────────────────────────────
// Auto-creates all tables on first run (idempotent)
